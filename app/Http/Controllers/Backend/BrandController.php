  ...
  public function BrandStore(Request $request){
    ...
    Brand::insert([
      ...
      'brand_image'=>$save_url,
            ...
            $notification = array(
            'message' => 'Brand Inserted Successfully', 'alert-type' => 'success' 
        );
  ...
  public function BrandUpdate(Request $request){
    ...
    Brand::findOrFail($brand_id)->update([
      ...
      'brand_image'=>$save_url,
            ...
            $notification = array(
            'message' => 'Brand Updated Successfully', 'alert-type' => 'info' 
        );
   ...
   public function BrandDelete($id){
    ...
    Brand::findOrFail($id)->delete();
     ...
     $notification = array(
            'message' => 'Brand Deleted Successfully', 'alert-type' => 'info' 
        );
