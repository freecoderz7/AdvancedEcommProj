					...
					<div class="row"> <!-- start Fourth row -->
						...
						<div class="col-md-4"><!-- start col md 4 -->
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="product_color_en" class="form-control" value="Red,Black,Green" data-role="tagsinput" required=""> 
						...
						<div class="col-md-4"><!-- start col md 4 -->
								...
								<div class="controls">
									<input type="text" name="product_color_hin" class="form-control" value="Red,Black,Green" data-role="tagsinput" required=""> 
